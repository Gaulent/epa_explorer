read_epa <- function(x)
{
  ...
  NMADRE <- substr(fichero, 24, 25) # 15% vacio
  #RELLMILI <- substr(fichero, 26, 26) # 98% Vacio
  ECIV1 <- substr(fichero, 27, 27) # 15% vacio
  # ----NACIM
  PRONA1 <- substr(fichero, 28, 29) # 5% vacio
  #REGNA1 <- substr(fichero, 30, 32) # 94% vacio
  NAC1 <- substr(fichero, 33, 33)
  #EXREGNA1 <- substr(fichero, 34, 36) # 95% vacio
  #ANORE1 <- substr(fichero, 37, 38) # 95% vacio
  # ----B
  NFORMA <- substr(fichero, 39, 40) # 15% vacio
